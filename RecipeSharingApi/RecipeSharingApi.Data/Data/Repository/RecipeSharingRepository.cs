...
namespace RecipeSharingApi.DataLayer.Data.Repository
{
    public class RecipeSharingRepository<Tentity> : IRecipeSharingRepository<Tentity> where Tentity : BaseEntity
    {
        private readonly RecipeSharingDbContext _dbContext;

        public RecipeSharingRepository(RecipeSharingDbContext dbContext)
        {
